...
#args ={'TimeSlot': 15, 'Groups': 12,'Profesores':16, 'MateriasMaximas':3, 'Materias':10}
args ={'TimeSlot': 4, 'Groups': 4,'Profesores':8, 'MateriasMaximas':3, 'Materias':5}
#Parametros del algoritmo
#param = {'ParticulasxEnjambre': 8,'Enjambres': 10,'Iteraciones': 100}
...
def imprimirResultado():
    ...
    contador=1
    for e in enjambres:#Por cada enjambre
        print('Enjambre #'+str(contador)+'  Mejor particula:'+str(e.mejorPos))
        contador+=1
...
for iteracion in range(0,param['Iteraciones']):
    print('\n')
